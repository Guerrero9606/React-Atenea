...
<h1>⭐ Mis Favoritos</h1>
      {favoritos.length === 0 ? (
<p>No tienes ningún producto en tu lista.</p>
      ) : (
<>
...
<ul style={{ listStyle: 'none', padding: 0 }}>
            {favoritos.map((item) => (
<li key={item.id} style={{ background: 'white', padding: '15px', marginBottom: '10px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
